...
const corpototal = document.getElementById('voltartopo')
...
async function Pokemonid(){
    try{
        ...
        const numberdex = document.getElementById('numberdex')
            ...
            if(event.key === 'Enter'){
                if(htp.value === data.name){
                    ...
                    if(data.abilities.length == 1){
                        hab1.innerHTML = data.abilities[0].ability.name.charAt(0).toUpperCase() + data.abilities[0].ability.name.slice(1)
                        hab2.innerHTML = ''
                        hab3.innerHTML = ''
                    }else if(data.abilities.length == 2){
                        hab1.innerHTML = data.abilities[0].ability.name.charAt(0).toUpperCase() + data.abilities[0].ability.name.slice(1)
                        hab2.innerHTML = data.abilities[1].ability.name.charAt(0).toUpperCase() + data.abilities[1].ability.name.slice(1)
                        hab3.innerHTML = ''
                    }else if(data.abilities.length == 3){
                        hab1.innerHTML = data.abilities[0].ability.name.charAt(0).toUpperCase() + data.abilities[0].ability.name.slice(1)
                        hab2.innerHTML = data.abilities[1].ability.name.charAt(0).toUpperCase() + data.abilities[1].ability.name.slice(1)
                        hab3.innerHTML = data.abilities[2].ability.name.charAt(0).toUpperCase() + data.abilities[2].ability.name.slice(1)
                    }
                    ...
                    numberdex.innerHTML = `Nº Pokedex: ${pokedex}`
